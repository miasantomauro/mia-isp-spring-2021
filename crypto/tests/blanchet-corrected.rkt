...
(test blanchet_corrected_sanity
      #:preds [
               ...
               ; Enforce neither in vacuity check since both have a listener
...
(test blanchet_corrected_initiator
      #:preds [
               exec_blanchet-corrected_init
               exec_blanchet-corrected_resp
               constrain_skeleton_blanchet-corrected_0 ;; initiator's POV
               ;constrain_skeleton_blanchet-corrected_1                
               temporary
               wellformed
...
(test blanchet_corrected_responder
      #:preds [
               exec_blanchet-corrected_init
               exec_blanchet-corrected_resp
               ;constrain_skeleton_blanchet-corrected_0 
               constrain_skeleton_blanchet-corrected_1  ;; responder's POV              
               temporary
               wellformed
